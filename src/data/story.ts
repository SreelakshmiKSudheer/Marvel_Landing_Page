export const storyCategories = [
  {
    ...
    href: "/movies",
    description: "See the universe come alive.",
  ...
  },
  {
    ...
    href: "/comics",
    description: "Where the legends began.",
  ...
  },
  {
    ...
    href: "/tv-shows",
    description: "Stories that continue beyond the screen.",
  ...
  },
  {
    ...
    href: "/games",
    description: "Become part of the fight.",
    detail: "Step into the action with Marvel games that let you play as your favorite characters and immerse yourself in epic battles and adventures.",
  },
];